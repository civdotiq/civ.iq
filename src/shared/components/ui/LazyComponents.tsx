    ...
    <div className="space-y-3">
      {[...Array(5)].map((_, i) => (
        <div key={i} className="flex items-center gap-3">
          ...
          <div className="flex-1 h-6 bg-white border-2 border-gray-300 rounded-full">
            <div
...
const _MapSkeleton = () => (
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-green-100 animate-pulse">
      <div className="absolute top-4 left-4 bg-white p-3 border-2 border-black">
        <div className="space-y-2">
          <div className="h-4 bg-gray-200 rounded w-32 animate-pulse"></div>
          <div className="h-3 bg-gray-200 rounded w-24 animate-pulse"></div>
        </div>
      </div>
      <div className="absolute bottom-4 right-4 bg-white p-2 border-2 border-black">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    {[...Array(6)].map((_, i) => (
      <div key={i} className="bg-white border border-gray-200 p-6">
        ...
        <div className="h-32 bg-white border-2 border-gray-300 rounded animate-pulse"></div>
...
export const LazyVotingPatternHeatmap = lazy(() =>
  import(/* webpackChunkName:"d3-visualizations" */ './InteractiveVisualizations').then(module => ({
...
export const LazyCampaignFinanceFlow = lazy(() =>
  import(/* webpackChunkName:"d3-visualizations" */ './InteractiveVisualizations').then(module => ({
    default: module.CampaignFinanceFlow,
  }))
);

export const LazyLegislativeSuccessFunnel = lazy(() =>
  import(/* webpackChunkName:"d3-visualizations" */ './InteractiveVisualizations').then(module => ({
    default: module.LegislativeSuccessFunnel,
  }))
);
