...
// Extracted to a dependency-free module (this file's import graph includes
// the AI provider chain, which non-analyzer callers must not inherit).
// Re-exported here so existing analyzer imports keep working.
export { mapWithConcurrency } from '@/lib/utils/concurrency';
