...
// ============================================================================
// CENSUS FIPS CODE TO ABBREVIATION
// ============================================================================

/**
 * Two-digit Census state FIPS code → abbreviation, all 50 states plus DC and
 * the 5 territories. Gaps in the sequence (03, 07, 14, 43, 52…) are real —
 * FIPS never reassigned retired codes.
 */
export const STATE_FIPS_TO_CODE: Record<string, StateCode> = {
  '01': 'AL',
  '02': 'AK',
  '04': 'AZ',
  '05': 'AR',
