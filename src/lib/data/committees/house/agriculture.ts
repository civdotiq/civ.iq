...
// IMPORTANT: This file contains the correct House Agriculture Committee membership
// for the 119th Congress (2025-2027) based on official sources.
...
// Source: House Agriculture Committee official website and Congressional records
...
// Republican members (in order as listed on committee website)
const republicanMembers: EnhancedRepresentative[] = [
  ...
  createRepresentative('D000032', 'Monica De La Cruz', 'R', 'TX', '15'),
...
// Democratic members (in order as listed on committee website)
const democraticMembers: EnhancedRepresentative[] = [
  ...
  createRepresentative('R000617', 'Josh Riley', 'D', 'NY', '19'),
  createRepresentative('B001340', 'Nikki Budzinski', 'D', 'IL', '13'),
  createRepresentative('D000230', 'Donald Davis', 'D', 'NC', '01'),
  createRepresentative('V000081', 'Nydia Velázquez', 'D', 'NY', '07'),
  createRepresentative('R000305', 'Kristen McDonald Rivet', 'D', 'MI', '08'),
  createRepresentative('V000136', 'Eugene Vindman', 'D', 'VA', '07'),
  createRepresentative('C001134', 'Herb Conaway', 'D', 'NJ', '03'),
  createRepresentative('D000633', 'April McClain Delaney', 'D', 'MD', '06'),
];
