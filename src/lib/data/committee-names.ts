...
export const COMMITTEE_INFO: Record<string, CommitteeInfo> = {
  ...
  'HSAG': {
    ...
    description: 'Oversees the nation\'s agricultural policies, food security, and rural development programs.',
    jurisdiction: ['Agriculture and agricultural commodities', 'Food and nutrition programs', 'Rural development', 'Forestry and forest reserves', 'Crop insurance and disaster assistance'],
    chamber: 'house'
  },
  'HSAP': {
    name: 'House Committee on Appropriations',
    description: 'Controls federal government spending and appropriations for all government agencies and programs.',
    jurisdiction: ['Federal budget appropriations', 'Government spending oversight', 'Discretionary spending programs', 'Emergency funding', 'Federal agency funding'],
    chamber: 'house'
  },
  'HSAS': {
    name: 'House Committee on Armed Services',
    description: 'Oversees the Department of Defense, military operations, and national security policy.',
    jurisdiction: ['Defense Department policy', 'Military personnel and benefits', 'Defense procurement', 'Military installations', 'National security strategy'],
    chamber: 'house'
  },
  'HSBA': {
    ...
    jurisdiction: ['Small business programs', 'SBA oversight', 'Small business lending', 'Entrepreneurship support', 'Small business regulatory issues'],
    chamber: 'house'
  },
  'HSBU': {
    name: 'House Committee on Budget',
    description: 'Responsible for the federal budget process and fiscal policy oversight.',
    jurisdiction: ['Federal budget resolution', 'Budget process oversight', 'Fiscal policy', 'Deficit and debt issues', 'Budget enforcement'],
    chamber: 'house'
  },
  'HSED': {
    ...
    jurisdiction: ['Education policy', 'Higher education', 'Workforce development', 'Labor relations', 'Employment standards'],
    chamber: 'house'
  },
  'HSFA': {
    ...
    jurisdiction: ['Foreign policy', 'International relations', 'Diplomatic affairs', 'Foreign aid', 'International trade policy'],
    chamber: 'house'
  },
  'HSGO': {
    name: 'House Committee on Oversight and Reform',
    description: 'Investigates government operations and ensures accountability across federal agencies.',
    jurisdiction: ['Government operations oversight', 'Federal agency accountability', 'Government waste and fraud', 'Civil service', 'Government efficiency'],
    chamber: 'house'
  },
  'HSHA': {
    ...
    jurisdiction: ['House administration', 'Federal election oversight', 'Campaign finance', 'House operations', 'Election security'],
    chamber: 'house'
  },
  'HSIF': {
    name: 'House Committee on Energy and Commerce',
    description: 'Regulates interstate commerce, energy policy, and telecommunications.',
    jurisdiction: ['Energy policy', 'Interstate commerce', 'Telecommunications', 'Health care', 'Consumer protection'],
    chamber: 'house'
  },
  'HSIG': {
    name: 'House Committee on Intelligence',
    description: 'Oversees the intelligence community and national security intelligence activities.',
    jurisdiction: ['Intelligence community oversight', 'National security intelligence', 'Intelligence budget', 'Counterintelligence', 'Intelligence operations'],
    chamber: 'house'
  },
  'HSII': {
    name: 'House Committee on Natural Resources',
    description: 'Manages public lands, natural resources, and environmental policies.',
    jurisdiction: ['Public lands', 'Natural resources', 'Environmental policy', 'National parks', 'Water resources'],
    chamber: 'house'
  },
  'HSJU': {
    name: 'House Committee on Judiciary',
    description: 'Oversees the federal judiciary, constitutional law, and civil rights.',
    jurisdiction: ['Federal judiciary', 'Constitutional law', 'Civil rights', 'Immigration', 'Antitrust law'],
    chamber: 'house'
  },
  'HSPO': {
    name: 'House Committee on Ethics',
    description: 'Investigates ethical violations and maintains standards of conduct for House members.',
    jurisdiction: ['Ethics investigations', 'Standards of conduct', 'Financial disclosure', 'Conflicts of interest', 'Ethics training'],
    chamber: 'house'
  },
  'HSPW': {
    ...
    jurisdiction: ['Transportation policy', 'Infrastructure development', 'Highway and transit systems', 'Aviation', 'Water infrastructure'],
    chamber: 'house'
  },
  'HSRU': {
    name: 'House Committee on Rules',
    description: 'Determines the rules and procedures for House floor consideration of legislation.',
    jurisdiction: ['House rules and procedures', 'Floor consideration', 'Legislative process', 'Debate rules', 'Amendment procedures'],
    chamber: 'house'
  },
  'HSSO': {
    ...
    jurisdiction: ['Scientific research', 'Space exploration', 'Technology development', 'NSF oversight', 'NASA policy'],
    chamber: 'house'
  },
  'HSWM': {
    name: 'House Committee on Ways and Means',
    description: 'Handles tax policy, trade, and Social Security legislation.',
    jurisdiction: ['Tax policy', 'International trade', 'Social Security', 'Medicare', 'Customs and tariffs'],
    chamber: 'house'
  },
  'HSVY': {
    name: 'House Committee on Veterans\' Affairs',
    description: 'Oversees veterans\' benefits, healthcare, and services.',
    jurisdiction: ['Veterans benefits', 'VA healthcare', 'Veterans services', 'Military pensions', 'Veterans education'],
    chamber: 'house'
  },
  'HSFS': {
    name: 'House Committee on Financial Services',
    description: 'Regulates financial institutions, housing policy, and insurance.',
    jurisdiction: ['Financial institutions', 'Housing policy', 'Insurance regulation', 'Securities markets', 'Consumer financial protection'],
    chamber: 'house'
  },
  'HSHL': {
    ...
    jurisdiction: ['Homeland security', 'Border protection', 'Emergency preparedness', 'Cybersecurity', 'Immigration enforcement'],
    chamber: 'house'
  },
  ...
  'SSAG': {
    ...
    jurisdiction: ['Agriculture policy', 'Nutrition programs', 'Forestry', 'Rural development', 'Food safety'],
    chamber: 'senate'
  },
  'SSAP': {
    name: 'Senate Committee on Appropriations',
    description: 'Controls federal government spending and budget appropriations.',
    jurisdiction: ['Federal appropriations', 'Budget oversight', 'Government spending', 'Agency funding', 'Emergency appropriations'],
    chamber: 'senate'
  },
  'SSAS': {
    name: 'Senate Committee on Armed Services',
    description: 'Oversees military affairs, defense policy, and national security.',
    jurisdiction: ['Defense policy', 'Military affairs', 'National security', 'Defense procurement', 'Military personnel'],
    chamber: 'senate'
  },
  'SSBA': {
    ...
    jurisdiction: ['Banking regulation', 'Housing policy', 'Urban development', 'Financial institutions', 'Securities regulation'],
    chamber: 'senate'
  },
  'SSBU': {
    name: 'Senate Committee on Budget',
    description: 'Oversees federal budget process and fiscal policy.',
    jurisdiction: ['Federal budget', 'Fiscal policy', 'Budget process', 'Deficit reduction', 'Budget enforcement'],
    chamber: 'senate'
  },
  'SSCM': {
    ...
    jurisdiction: ['Interstate commerce', 'Science policy', 'Transportation', 'Telecommunications', 'Consumer protection'],
    chamber: 'senate'
  },
  'SSEG': {
    ...
    jurisdiction: ['Energy policy', 'Natural resources', 'Public lands', 'Mineral resources', 'Energy development'],
    chamber: 'senate'
  },
  'SSEV': {
    ...
    jurisdiction: ['Environmental protection', 'Public works', 'Water resources', 'Transportation infrastructure', 'Clean air and water'],
    chamber: 'senate'
  },
  'SSFI': {
    name: 'Senate Committee on Finance',
    description: 'Oversees tax policy, trade, and social programs.',
    jurisdiction: ['Tax policy', 'International trade', 'Social Security', 'Medicare', 'Healthcare financing'],
    chamber: 'senate'
  },
  'SSFO': {
    name: 'Senate Committee on Foreign Relations',
    description: 'Handles foreign policy, international relations, and treaties.',
    jurisdiction: ['Foreign policy', 'International relations', 'Treaties', 'Foreign aid', 'Diplomatic affairs'],
    chamber: 'senate'
  },
  'SSGA': {
    ...
    jurisdiction: ['Homeland security', 'Government operations', 'Federal workforce', 'Government efficiency', 'Emergency management'],
    chamber: 'senate'
  },
  'SSHR': {
    ...
    jurisdiction: ['Health policy', 'Education policy', 'Labor relations', 'Employment standards', 'Public health'],
    chamber: 'senate'
  },
  'SSIG': {
    ...
    jurisdiction: ['Intelligence oversight', 'National security intelligence', 'Intelligence budget', 'Counterintelligence', 'Intelligence operations'],
    chamber: 'senate'
  },
  'SSJU': {
    name: 'Senate Committee on Judiciary',
    description: 'Oversees federal judiciary, constitutional law, and civil rights.',
    jurisdiction: ['Federal judiciary', 'Constitutional law', 'Civil rights', 'Immigration', 'Criminal justice'],
    chamber: 'senate'
  },
  'SSRU': {
    name: 'Senate Committee on Rules and Administration',
    description: 'Manages Senate rules, procedures, and administration.',
    jurisdiction: ['Senate rules', 'Senate procedures', 'Federal elections', 'Senate administration', 'Campaign finance'],
    chamber: 'senate'
  },
  'SSSB': {
    ...
    jurisdiction: ['Small business policy', 'Entrepreneurship', 'SBA oversight', 'Small business lending', 'Business development'],
    chamber: 'senate'
  },
  'SSVA': {
  ...
  'SSIN': {
    ...
    jurisdiction: ['Native American affairs', 'Tribal sovereignty', 'Indian lands', 'Tribal economic development', 'Indigenous rights'],
    chamber: 'senate'
  },
  ...
  'JCEC': {
    ...
    jurisdiction: ['Economic policy', 'Economic research', 'Economic conditions', 'Economic statistics', 'Economic forecasting'],
    chamber: 'joint'
  },
  'JCLC': {
    name: 'Joint Committee on the Library',
    description: 'Oversees the Library of Congress and its operations.',
    jurisdiction: ['Library of Congress', 'Congressional research', 'Library services', 'Information management', 'Congressional records'],
    chamber: 'joint'
  },
  'JCPR': {
    name: 'Joint Committee on Printing',
    description: 'Oversees government printing and document distribution.',
    jurisdiction: ['Government printing', 'Document distribution', 'Government publications', 'Printing standards', 'Publication oversight'],
    chamber: 'joint'
  },
  'JCTX': {
    name: 'Joint Committee on Taxation',
    description: 'Provides nonpartisan analysis of tax legislation and policy.',
    jurisdiction: ['Tax analysis', 'Tax policy', 'Revenue estimates', 'Tax legislation', 'Tax administration'],
    chamber: 'joint'
  },
  ...
  'SCAG': {
    ...
    jurisdiction: ['Climate change', 'Environmental policy', 'Clean energy', 'Climate science', 'Climate adaptation'],
    chamber: 'house'
  },
  'SCCH': {
    ...
    jurisdiction: ['China policy', 'National security', 'Economic competition', 'Technology transfer', 'Human rights'],
    chamber: 'house'
  },
  'SCWG': {
    ...
    jurisdiction: ['Government accountability', 'Federal agency oversight', 'Civil liberties', 'Government abuse', 'Constitutional rights'],
    chamber: 'house'
  },
  ...
  'SPAG': {
    ...
    jurisdiction: ['Aging policy', 'Senior citizens', 'Medicare', 'Social Security', 'Long-term care'],
    chamber: 'senate'
  }
};
...
export const SUBCOMMITTEE_MAPPINGS: Record<string, Array<{id: string, name: string}>> = {
  ...
  'HSAS': [
    ...
    { id: 'HSAS06', name: 'Subcommittee on Cyber, Innovative Technologies, and Information Systems' }
  ],
  ...
  'HSAP': [
    ...
    { id: 'HSAP07', name: 'Subcommittee on Agriculture, Rural Development, Food and Drug Administration' },
    ...
    { id: 'HSAP12', name: 'Subcommittee on Military Construction, Veterans Affairs, and Related Agencies' }
  ],
  ...
  'HSFS': [
    ...
    { id: 'HSFS04', name: 'Subcommittee on National Security, International Development and Monetary Policy' },
  ...
  'SSJU': [
    ...
    { id: 'SSJU02', name: 'Subcommittee on Federal Courts, Oversight, Agency Action, and Federal Rights' },
  ...
  'SSAP': [
    ...
    { id: 'SSAP07', name: 'Subcommittee on Agriculture, Rural Development, Food and Drug Administration' },
    ...
    { id: 'SSAP12', name: 'Subcommittee on Military Construction, Veterans Affairs, and Related Agencies' }
  ],
  
  // Senate Finance Committee Subcommittees
  'SSFI': [
    { id: 'SSFI01', name: 'Subcommittee on International Trade, Customs, and Global Competitiveness' },
