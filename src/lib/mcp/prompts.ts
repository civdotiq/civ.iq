      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '4. get_district_pharma_payments — pharma industry payments',
              '5. get_district_disaster_history — FEMA disaster declarations',
              '6. get_district_consumer_complaints — CFPB complaint patterns',
              '7. get_district_housing_profile — HUD housing affordability',
              '8. get_district_education_profile — higher education landscape',
              '9. get_district_research_profile — NIH-funded research',
              '10. get_district_banking_profile — FDIC banking landscape',
              '11. get_state_energy_profile — energy production and consumption',
              '12. get_climate_data — NOAA climate normals',
              '',
              ...
              '- Healthcare infrastructure and pharma industry presence',
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '',
              'If the sector is Health-related, also use:',
              '- search_fda_recalls — FDA enforcement',
              '- search_open_payments — pharma payments to physicians',
              '',
              'If Energy-related:',
