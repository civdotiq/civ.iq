...
describe('ReadingLevelValidator', () => {
  describe('analyzeReadingLevel', () => {
    ...
    it('should calculate syllables correctly', () => {
      ...
      const multiSyllableText =
        'The feline situated itself upon the material. It was a magnificent creature.';
  ...
  describe('meetsTarget', () => {
    it('should correctly identify if text meets 8th grade target', () => {
      const simpleText =
        'This law helps people. It gives money to schools. Students can learn better.';
      const complexText =
        'This comprehensive legislation facilitates educational enhancement through financial appropriations.';
    ...
    it('should validate multiple texts efficiently', () => {
      const texts = [
        { id: 'simple', content: 'This is easy text. Short words. Simple ideas.' },
        {
          id: 'complex',
          content:
            'This demonstrates sophisticated linguistic complexity with multisyllabic terminology.',
        },
      ];
