...
export const metadata: Metadata = {
  ...
  description:
    'Find your federal and state representatives with real government data. Track bills, votes, campaign finance, and more.',
  keywords: [
    'congress',
    'representatives',
    'senators',
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <OrganizationSchema />
        <WebSiteSchema
          alternateName={['civdotiq', 'civdotiq.org', 'CIV.IQ Civic Intelligence']}
          searchAction={{
