...
export function LegacyRegulationsPage() {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Federal Register', url: 'https://civdotiq.org/regulations' },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              <div className="text-amber-600 mb-2">Failed to load regulations</div>
              <button
