...
// Main Districts Page (legacy — preserved as default route, replaced by
// SearchVariants/DistrictListingPage when ?v=new is set)
export function LegacyDistrictsPage() {
  const {
    districts,
    apiLoading,
    error,
        ...
        <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
          ...
          <div className="mb-4 sm:mb-8">
            ...
            <p className="text-sm sm:text-xl text-gray-600">
              Explore demographic, political, and geographic data for all U.S. congressional
              districts
            </p>
          </div>
              ...
              {process.env.NODE_ENV === 'development' && fetchDuration !== null && (
                <div className="bg-gray-50 border border-gray-200 px-4 py-2 mb-4 text-xs text-gray-600">
                  <div className="flex justify-between">
                    <span>
                      Districts loaded in {fetchDuration.toFixed(0)}ms • {districts.length}{' '}
                      districts
                    </span>
                    <span>
                      Cache:{' '}
