              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      <h5 className="text-sm font-medium text-gray-700 mb-2">Washington, DC Office</h5>
                        ...
                        {representative.currentTerm?.phone && (
                          <div className="flex">
                            ...
                            <dd className="text-sm text-gray-900">
                              <a href={`tel:${representative.currentTerm.phone}`} className="text-blue-600 hover:text-blue-800">
                                {representative.currentTerm.phone}
                              </a>
                            </dd>
                          </div>
                    ...
                    <div className="mb-4">
                      <h5 className="text-sm font-medium text-gray-700 mb-2">State/District Offices</h5>
                      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        ...
                        <p className="text-xs text-yellow-700 mt-1">
                          Please visit the official website or contact the Washington office for local office locations and hours.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                          ...
                          <div className="flex items-center justify-between mb-2">
                            ...
                            {committee.role && (
                              <span className={`text-xs px-2 py-1 rounded ${
                                ...
                                committee.role === 'Ranking Member' ? 'bg-orange-100 text-orange-800' :
                    ...
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-blue-800 font-medium">Committee Information</span>
                      </div>
                      <p className="text-xs text-blue-700 mt-1">
                        {representative.name} serves on {representative.committees.length} committee{representative.committees.length !== 1 ? 's' : ''}. 
                        Committee assignments determine legislative priorities and specialization areas.
                      </p>
                    </div>
                  </div>
                )}
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="text-xs text-gray-500 space-y-2">
                          <div className="bg-white p-2 rounded border-l-2 border-blue-400">
                            ...
                            <p className="text-gray-500 text-xs mt-1">Real-time Twitter feed integration coming soon</p>
                          </div>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="text-xs text-gray-500 space-y-2">
                          <div className="bg-white p-2 rounded border-l-2 border-blue-600">
                            ...
                            <p className="text-gray-500 text-xs mt-1">Real-time Facebook feed integration coming soon</p>
                          </div>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="text-xs text-gray-500 space-y-2">
                          <div className="bg-white p-2 rounded border-l-2 border-red-600">
                            ...
                            <p className="text-gray-500 text-xs mt-1">Real-time YouTube feed integration coming soon</p>
                          </div>
                        </div>
                      </div>
                    )}
