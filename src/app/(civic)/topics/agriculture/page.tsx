  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <CollectionPageSchema
        name="Agriculture Legislation & Policy"
        description="Track agriculture legislation including farm policy, food safety, rural development, and nutrition."
        url="https://civdotiq.org/topics/agriculture"
      />
