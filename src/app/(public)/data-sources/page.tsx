    ...
    <div className="grid gap-8 mb-16">
     {dataSources.map((source) => {
      ...
      return (
       <div
        key={source.name}
        className={`bg-white rounded-2xl border-2 border-black p-8 border transition-all duration-300 hover:border-2 border-black-xl ${
        ...
        <div className="flex items-start gap-6">
         ...
         <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
           ...
           {source.status === 'planned' && (
            <span className="px-3 py-1 bg-white border-2 border-gray-300 text-gray-600 text-sm rounded-full">
             Coming in Phase 2
            </span>
           )}
          </div>
