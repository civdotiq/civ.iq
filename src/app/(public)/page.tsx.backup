          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
              <div className="md:col-span-2 animate-fade-in-up">
                ...
                <p className="text-gray-300 leading-relaxed text-lg max-w-md">
                  A civic utility providing transparent access to government data. All information
                  sourced from official government APIs.
                </p>
              </div>
            ...
            <div className="text-center pt-8 border-t border-gray-700 space-y-2">
              ...
              <p className="text-gray-500 text-sm">
                Original code and design protected • Government data remains public domain
              </p>
            </div>
          </div>
        </div>
