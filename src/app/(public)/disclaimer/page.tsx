    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Disclaimer', url: 'https://civdotiq.org/disclaimer' },
        ]}
      />
            ...
            <div className="prose prose-gray max-w-none">
              <section className="mb-grid-4">
                ...
                <p className="text-gray-700 leading-relaxed mb-grid-2">
                  ...
                  federal and state representatives, plus 5 pilot cities for local government.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  <strong>What we are:</strong> An informational tool that presents publicly
                  available civic data in an easy-to-understand format.
                </p>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section className="mb-grid-4">
                ...
                <p className="text-gray-700 leading-relaxed mb-grid-2">
                  All data on CIV.IQ comes directly from official government APIs and public
                  sources:
                </p>
                ...
                <p className="text-gray-700 leading-relaxed">
                  While we make every effort to provide accurate and up-to-date information, we
                  cannot guarantee:
                </p>
              ...
              <section className="mb-grid-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  CIV.IQ is a <strong>non-partisan civic utility</strong>. We do not endorse,
                  support, or oppose any candidate, political party, or legislation. The inclusion
                  of any representative, bill, or voting record is purely informational and does not
              ...
              <section className="mb-grid-4">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  social media profiles). We are not responsible for the content, accuracy, or
