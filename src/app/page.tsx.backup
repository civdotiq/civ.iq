      ...
      <div className="flex flex-col justify-center items-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center p-grid-3 bg-white border-aicher border-black hover:border-civiq-blue transition-colors">
              <div className="w-grid-6 h-grid-6 bg-civiq-blue flex items-center justify-center mb-grid-2 border-aicher border-black">
            ...
            <div className="flex flex-col items-center p-grid-3 bg-white border-aicher border-black hover:border-civiq-blue transition-colors">
              <div className="w-grid-6 h-grid-6 bg-civiq-green flex items-center justify-center mb-grid-2 border-aicher border-black">
            ...
            <div className="flex flex-col items-center p-grid-3 bg-white border-aicher border-black hover:border-civiq-blue transition-colors">
              <div className="w-grid-6 h-grid-6 bg-civiq-red flex items-center justify-center mb-grid-2 border-aicher border-black">
