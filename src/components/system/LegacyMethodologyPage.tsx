 ...
 *
 * Legacy methodology page — lifted from the original
 * src/app/(civic)/methodology/page.tsx so the redesign can ship behind ?v=new
 * while leaving the default route unchanged.
 */
...
export function LegacyMethodologyPage() {
  return (
