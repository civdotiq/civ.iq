    ...
    <div className="bg-white border-2 border-black overflow-hidden animate-pulse">
      ...
      <div className="p-4">
        <div className="flex items-start space-x-4">
          {/* Image placeholder */}
          <div className="flex-shrink-0 w-24 h-24 bg-gray-200"></div>

          {/* Content */}
          <div className="flex-1 space-y-2">
            <div className="h-5 w-full bg-gray-200"></div>
            <div className="h-5 w-4/5 bg-gray-200"></div>
  ...
  const renderTopicsSkeleton = () => (
    <div className="bg-white border-2 border-black p-4 animate-pulse">
      <div className="flex items-start space-x-3">
        <div className="w-3 h-3 bg-gray-200 mt-2"></div>
        <div className="flex-1 space-y-2">
  ...
  const renderTimelineSkeleton = () => (
    <div className="flex items-start space-x-4 animate-pulse">
      <div className="flex-shrink-0 w-16 text-center space-y-1">
        ...
        <div className="h-4 w-8 bg-gray-200 mx-auto"></div>
      </div>
  ...
  const renderCoverageSkeleton = () => (
    <div className="bg-white border-2 border-black overflow-hidden animate-pulse">
      ...
      <div className="p-6 border-b border-gray-100">
        ...
        <div className="h-7 w-4/5 bg-gray-200 mb-3"></div>
      ...
      <div className="p-6 space-y-3">
        ...
        <div className="h-6 w-5/6 bg-gray-200"></div>
        <div className="h-4 w-full bg-gray-200"></div>
      ...
      <div className="border-t border-gray-100 bg-gray-50 p-4">
        <div className="h-5 w-32 bg-gray-200 mb-3"></div>
