      ...
      <div className="px-4 py-3 bg-gray-50 border-t border-gray-100 rounded-b-lg">
        <div className="flex items-center justify-between text-xs text-gray-500">
          <div className="flex items-center gap-2">
            ...
            <span>AI-generated summary • Simplified to {summary.readingLevel}th grade level</span>
          </div>
          <div className="flex items-center gap-1">
    ...
    <div className={`bg-white rounded-lg border border-red-200 shadow-sm ${className}`}>
      <div className="p-4">
        ...
        <p className="text-gray-700 mb-4">
          {error ||
            'Unable to generate AI summary for this bill. The full bill text is still available.'}
        </p>
        {onRetry && (
          <button
            onClick={onRetry}
