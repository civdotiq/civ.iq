    ...
    >
      ...
      <div className="absolute top-3 right-3 z-[1000] flex flex-col gap-2">
        <button
          ...
          className="bg-white hover:bg-gray-100 border-2 border-black p-2 transition-colors"
  ...
  if (isFullscreen) {
    return (
      <div className="fixed inset-0 z-50 bg-white">
        ...
        <button
          onClick={toggleFullscreen}
          className="absolute top-4 left-4 z-[1001] bg-white hover:bg-gray-100 border-2 border-black px-4 py-2 transition-colors"
        >
          Exit Fullscreen
        </button>
      </div>
