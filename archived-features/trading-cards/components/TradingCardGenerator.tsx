...
export function TradingCardGenerator({
  ...
  const generateCard = async () => {
    ...
    try {
      ...
      structuredLogger.error('Card generation failed:', error as Error);
  ...
  const downloadCard = () => {
    ...
    try {
      ...
      structuredLogger.error('Download failed:', error as Error);
        ...
        {browserSupport && !browserSupport.supported && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 m-6">
            ...
            <p className="text-sm text-red-700 mt-1">
              Your browser doesn&apos;t support card generation. Please use a modern browser like
                    ...
                    >
                      ...
                      {generationResult.success && generationResult.metadata && (
                        <div className="mt-2 text-xs text-green-700">
                          <p>
                            Size: {generationResult.metadata.width}×
                            {generationResult.metadata.height}px
                          </p>
                          <p>
                            File size: {Math.round(generationResult.metadata.fileSize / 1024)}KB
                          </p>
                          <p>
                            Generation time: {Math.round(generationResult.metadata.generationTime)}
                            ms
                          </p>
                        </div>
                      )}
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={
                          browserSupport.features.canvas ? 'text-green-600' : 'text-red-600'
                        }
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={
                          browserSupport.features.download ? 'text-green-600' : 'text-red-600'
                        }
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={
                          browserSupport.features.highDPI ? 'text-green-600' : 'text-gray-500'
                        }
                      >
