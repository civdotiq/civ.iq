...
test.describe('Representative Detail Page', () => {
  ...
  test('should display voting records', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="voting-record"]').first()).toBeVisible({ timeout: 10000 });
  ...
  test('should display campaign finance data', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="finance-data"]').first()).toBeVisible({ timeout: 10000 });
  });
