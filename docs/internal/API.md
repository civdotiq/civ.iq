...
Real party-line alignment analysis. Uses the `party-line-analyzer` which derives
each party's majority position from actual member votes per roll call, then
computes peer averages from same-chamber, same-party legislators in the same
roll calls. Returns unavailable (zeros + metadata) for Independents or when
...
```json
{
  "overall_alignment": 92.3,
  "votes_with_party": 48,
  "votes_against_party": 4,
  "total_votes_analyzed": 52,
  "peer_average_alignment": 89.7,
  "peer_count": 195,
  "confidence": 0.87,
  "data_as_of": "2026-04-10",
  "methodology": "Alignment computed from 52 qualifying roll calls...",
  "disclaimer": "This analysis shows factual alignment..."
}
```
