...
| ------------------------ | -------------- | ---------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 — Security baseline    | 🟢 done        | 2026-04-15 | `7bdcae97`, `926579f6` | 16 vulns (12 high) → 10 high remaining. All 10 are transitive `tar` via `@huggingface/transformers@3.8.1`; accepted + documented in SECURITY.md (4.1.0 upgrade deferred — fresh release, new native deps, runtime breakage risk). |
| 2 — Integrity core       | 🔴 not started |            |                        |                                                                                                                                                                                                                                   |
